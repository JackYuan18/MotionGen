...
from train_reinforcement_ppo import train_epoch_ppo, downsample_states
...
def train_and_evaluate_trajectory(
    ...
    return {
        ...
        'downsample_ratio': args.downsample_ratio if args.downsample_ratio > 1 else None
    }
...
def main():
    ...
    downsample_ratio = args.downsample_ratio if args.downsample_ratio > 1 else 1
